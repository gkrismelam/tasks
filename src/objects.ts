...
export function isCorrect(question: Question, answer: string): boolean {
    const fullAnswer: string = answer.trim().toLowerCase();
    const fullExpected: string = question.expected.trim().toLowerCase();
    return fullExpected === fullAnswer;
}
...
export function toMarkdown(question: Question): string {
    let returnStr: string = `# ${question.name}\n${question.body}`;
    if (question.type === "multiple_choice_question") {
...
export function publishQuestion(question: Question): Question {
    const invertPublishedQuestion: Question = {
        ...question,
        published: !question.published,
    };
    return invertPublishedQuestion;
}
...
export function addOption(question: Question, newOption: string): Question {
    const addOptionQuestion: Question = {
        ...question,
